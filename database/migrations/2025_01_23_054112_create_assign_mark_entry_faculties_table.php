...
return new class extends Migration
{
    ...
    {
        Schema::create('assign_mark_entry_faculties', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('last_submission_date'); // Last Submission Date
    ...
    {
        Schema::table('assign_mark_entry_faculties', function (Blueprint $table) {
        ...
        Schema::dropIfExists('assign_mark_entry_faculties');
    }
};
