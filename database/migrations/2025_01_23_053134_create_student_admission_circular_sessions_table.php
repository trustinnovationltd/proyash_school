...
return new class extends Migration
{
    ...
    {
        Schema::create('student_admission_circular_sessions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('student_admission_circular_sessions', function (Blueprint $table) {
            $table->dropForeign(['institute_id']);
            $table->dropForeign(['academic_year_id']);
        });

        Schema::dropIfExists('student_admission_circular_sessions');
    }
};
