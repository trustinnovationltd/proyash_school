...
return new class extends Migration
{
    ...
    {
        Schema::create('class_routine_setups', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('period_id'); // Foreign Key to Period Setups table
            $table->unsignedBigInteger('employee_id'); // Foreign Key to Teachers table
            $table->string('name'); // Name of the routine
            $table->time('start_time'); // Start time of the routine
            $table->time('end_time'); // End time of the routine
            ...
            $table->foreign('period_id')->references('id')->on('period_setups')->onDelete('cascade');
    ...
    {
        Schema::table('class_routine_setups', function (Blueprint $table) {
        ...
        Schema::dropIfExists('class_routine_setups');
    }
};
