...
return new class extends Migration
{
    ...
    {
        Schema::create('syllabus_uploads', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('title'); // Title of the syllabus
            $table->string('files'); // File path for uploaded syllabus
    ...
    {
        Schema::table('syllabus_uploads', function (Blueprint $table) {
        ...
        Schema::dropIfExists('syllabus_uploads');
    }
};
