            ...
            <div class="container">
                <div class="page-title-wrap text-center w-100">
                    <div class="page-title-inner d-inline-block">
                        <h1 class="mb-0 text-white">Counselling</h1>
                        <ol class="breadcrumb mb-0 justify-content-center">
                            ...
                            <li class="breadcrumb-item active text-white">Counselling</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mrg30">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-8">
                            <div class="post-detail w-100">
                                ...
                                <p>
                                    At Proyash, our Counselling service is dedicated to providing emotional and
                                    psychological support to children and their families facing the unique challenges of
                                    developmental and behavioral conditions. Understanding and addressing emotional needs is
                                    essential for fostering confidence, resilience, and positive social interactions.
                                    <br><br>

                                    Our qualified counsellors work closely with children to help them express feelings,
                                    manage stress, and develop coping strategies in a safe and supportive environment. We
                                    also provide guidance and support to parents and caregivers, helping them navigate the
                                    complexities of raising children with special needs.<br><br>

                                    Through individual sessions, family counselling, and group support, our counselling team
                                    aims to strengthen emotional well-being, improve communication, and promote a harmonious
                                    home and learning environment. Our holistic approach ensures every child and family
                                    feels heard, valued, and empowered.
                                </p>
                                <blockquote>
                                    <p>
                                        <i class="flaticon-quote d-block"></i>
                                        Supporting Families, Strengthening Children.
                                    </p>
                                </blockquote>
                                <h3 class="mb-0">Quality Care From Quality Experts:</h3>
                                <p>
                                    At Proyash, we believe that emotional health is the foundation for a child’s overall
                                    development. Our counselling team consists of experienced and compassionate
                                    professionals who specialize in supporting children with developmental challenges and
                                    their families. <br> <br>

                                    Using evidence-based approaches and child-friendly methods, our counsellors create a
                                    safe space where children can express their feelings, learn coping skills, and build
                                    resilience. We also work closely with parents and caregivers, providing guidance and
                                    tools to foster understanding and positive relationships at home and in school.<br> <br>

                                    Our integrated approach ensures that emotional well-being is addressed alongside
                                    physical and educational needs, empowering every child to thrive with confidence and
                                    hope.
                                </p>
                                <div class="row">
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        <img style="width: 100%; height: auto; border-radius: 8px;"
                                            src="{{ asset('/frontend/assets/uploads/service/Counselling2.png') }}" />
                                    </div>
                                </div>
