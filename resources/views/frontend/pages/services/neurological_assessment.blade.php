            ...
            <div class="container">
                <div class="page-title-wrap text-center w-100">
                    <div class="page-title-inner d-inline-block">
                        <h1 class="mb-0 text-white">Neurological Assessment</h1>
                        <ol class="breadcrumb mb-0 justify-content-center">
                            ...
                            <li class="breadcrumb-item active text-white">Neurological Assessment</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mrg30">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-8">
                            <div class="post-detail w-100">
                                ...
                                <p>
                                    At Proyash, our Neurological Assessment service is dedicated to identifying and
                                    understanding disorders related to the brain, spinal cord, and nervous system that may
                                    affect a child’s movement, behavior, or development. Early detection of neurological
                                    issues is critical to planning effective treatment and ensuring long-term progress.
                                    <br><br>

                                    Our experienced neurologists conduct comprehensive evaluations that include observing
                                    motor functions, reflexes, coordination, muscle tone, balance, and developmental
                                    milestones. These assessments help diagnose conditions such as cerebral palsy, epilepsy,
                                    motor delays, and other neurodevelopmental disorders. <br><br>

                                    The evaluation process is designed to be child-friendly and supportive, involving both
                                    parents and caregivers. We use standardized tools and observations to get a complete
                                    picture of the child’s neurological health and provide recommendations for further
                                    intervention, therapies, or medical care as needed. <br> <br>

                                    With accurate diagnosis and a multidisciplinary approach, our goal is to support each
                                    child in reaching their fullest potential — academically, socially, and physically.
                                </p>
                                <blockquote>
                                    <p>
                                        <i class="flaticon-quote d-block"></i>
                                        Understanding the Brain, Empowering the Child.
                                    </p>
                                </blockquote>
                                <h3 class="mb-0">Quality Care From Quality Experts:</h3>
                                <p>
                                    At Proyash, we recognize that neurological health is fundamental to a child’s overall
                                    development and well-being. Our team of dedicated neurologists and specialists bring
                                    years of experience and advanced training in pediatric neurology. They work with
                                    patience, precision, and compassion to thoroughly evaluate and understand each child’s
                                    neurological condition. <br> <br>

                                    Using the latest diagnostic tools and child-friendly techniques, our experts provide
                                    detailed assessments that guide personalized treatment plans. We collaborate closely
                                    with families and multidisciplinary teams to ensure holistic care, helping children
                                    overcome neurological challenges and achieve their fullest potential.<br> <br>

                                    Our commitment to quality means your child receives expert care in a safe, nurturing
                                    environment — where every step is focused on growth, healing, and hope.
                                </p>
                                <div class="row">
                                    <div class="col-md-8">
                                        <h3>Treatments:</h3>
                                        <ul>
                                            ...
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Reflex testing and muscle tone evaluation
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Cognitive and developmental milestone screening
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                            ...
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Recommendations for therapy and medical intervention
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                    ...
                                    <div class="col-md-4">
                                        <img style="width: 100%; height: auto; border-radius: 8px;"
                                            src="{{ asset('/frontend/assets/uploads/service/NeurologicalAssessment2.png') }}" />
                                    </div>
                                </div>
