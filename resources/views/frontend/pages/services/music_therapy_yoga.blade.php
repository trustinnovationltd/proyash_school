...
@section('title', 'Music Therapy & Yoga')
@section('website_css')
@endsection
            ...
            <div class="container">
                <div class="page-title-wrap text-center w-100">
                    <div class="page-title-inner d-inline-block">
                        <h1 class="mb-0 text-white">Music Therapy & Yoga</h1>
                        <ol class="breadcrumb mb-0 justify-content-center">
                            ...
                            <li class="breadcrumb-item active text-white">Music Therapy & Yoga</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mrg30">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-8">
                            <div class="post-detail w-100">
                                ...
                                <p>
                                    At Proyash, our Music Therapy & Yoga program is designed to nurture emotional
                                    expression, improve sensory and motor skills, and promote inner calm in children with
                                    developmental challenges. Through structured sound, rhythm, movement, and mindfulness
                                    practices, we help children explore their emotions and build self-regulation skills in a
                                    joyful, non-verbal way. <br> <br>

                                    Music Therapy uses instruments, songs, and rhythm-based activities to stimulate
                                    communication, coordination, and emotional connection. Whether through drumming,
                                    singing, or listening, children engage in a therapeutic experience that enhances focus,
                                    speech, and social interaction.<br> <br>

                                    Yoga complements therapy by building strength, flexibility, body awareness, and
                                    relaxation. Simple postures, breathing exercises, and mindfulness help reduce anxiety
                                    and support attention and self-control — vital skills for children with autism, ADHD, or
                                    sensory issues.<br> <br>

                                    Together, music and yoga create a holistic healing space where children can express,
                                    explore, and grow — both physically and emotionally.
                                </p>
                                <blockquote>
                                    <p>
                                        <i class="flaticon-quote d-block"></i>
                                        Tune the Mind. Stretch the Strength.
                                    </p>
                                </blockquote>
                                <h3 class="mb-0">Quality Care From Quality Experts:</h3>
                                <p>
                                    Our Music Therapy & Yoga sessions are led by certified professionals trained in
                                    pediatric rehabilitation and child psychology. With deep understanding of
                                    neurodevelopmental conditions, our therapists design each session based on the child’s
                                    emotional, cognitive, and physical needs. <br> <br>

                                    Instruments are selected for their sensory impact and therapeutic benefit, while yoga
                                    postures are simplified and guided with safety in mind. Children are encouraged to
                                    participate freely — through rhythm, sound, breath, and gentle movement — at their own
                                    comfort level. <br> <br>

                                    Parents are often invited to observe or join, reinforcing trust and progress at home.
                                    This program brings the therapeutic power of creativity and calm into the lives of
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                &nbsp;&nbsp;Music-assisted communication and expression
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Speech stimulation through singing and rhythm
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Instrument-based sensory integration
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Group and one-on-one musical interaction sessions
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Yoga poses for strength, balance, and flexibility
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Breathing and relaxation techniques for emotional regulation
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                            ...
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Support for sensory and attention difficulties
                                            </li>
                                        </ul>
                                    ...
                                    <div class="col-md-4">
                                        <img style="width: 100%; height: auto; border-radius: 8px;"
                                            src="{{ asset('/frontend/assets/uploads/service/MusicTherapyYoga2.png') }}" />
                                    </div>
                                </div>
