            ...
            <div class="container">
                <div class="page-title-wrap text-center w-100">
                    <div class="page-title-inner d-inline-block">
                        <h1 class="mb-0 text-white">Diet Management</h1>
                        <ol class="breadcrumb mb-0 justify-content-center">
                            ...
                            <li class="breadcrumb-item active text-white">Diet Management</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mrg30">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-8">
                            <div class="post-detail w-100">
                                ...
                                <p>
                                    At Proyash, our Diet Management program is designed to support the unique nutritional
                                    needs of children with developmental and physical challenges. Proper nutrition plays a
                                    vital role in enhancing growth, cognitive function, and overall health, which are
                                    essential for effective therapy and daily functioning. <br> <br>

                                    Our team of expert dietitians works closely with medical professionals, therapists, and
                                    families to create personalized meal plans that address each child’s dietary
                                    requirements, food preferences, allergies, and swallowing abilities. We focus on
                                    promoting balanced nutrition, improving feeding skills, and managing special dietary
                                    needs such as texture modifications or supplements. <br> <br>

                                    Through regular assessments, monitoring, and parental education, we ensure children
                                    receive the nourishment they need to thrive, grow stronger, and maximize their
                                    developmental potential. Our goal is to empower families with practical strategies and
                                    nutritional guidance for long-term health and well-being.
                                </p>
                                <blockquote>
                                    <p>
                                        <i class="flaticon-quote d-block"></i>
                                        Customized Nutrition, Better Development.
                                    </p>
                                </blockquote>
                                <h3 class="mb-0">Quality Care From Quality Experts:</h3>
                                <p>
                                    At Proyash, we understand that proper nutrition is the cornerstone of a child’s growth
                                    and development. Our team of specialized dietitians and nutritionists bring expert
                                    knowledge and compassionate care to every child’s dietary management plan. We carefully
                                    evaluate each child’s unique needs, including medical conditions, feeding challenges,
                                    and developmental status, to create individualized nutrition strategies. <br> <br>

                                    Our experts collaborate closely with pediatricians, therapists, and families to ensure
                                    that dietary interventions support overall health, improve feeding skills, and enhance
                                    the effectiveness of therapeutic programs. Through ongoing monitoring and education, we
                                    empower caregivers with practical tools and knowledge to maintain healthy eating habits
                                    at home.<br> <br>

                                    With a commitment to quality and personalized care, Proyash provides nutrition services
                                    that help children build strength, boost immunity, and achieve their full potential.
                                </p>
                                <div class="row">
                                    <div class="col-md-8">
                                        <h3>Treatments:</h3>
                                        <ul>
                                            <li>
                                                ...
                                                &nbsp;&nbsp;Individualized nutritional assessment and planning
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                            ...
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Special diets for allergies and medical conditions
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Texture modification and feeding technique guidance
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Supplement recommendations and management
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Parental education and counseling on nutrition
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Collaboration with medical and therapy teams
                                            </li>
                                            <li>
                                                <i class="fas fa-chevron-circle-right" style="color: #FFD43B;"></i>
                                                &nbsp;&nbsp;Addressing feeding difficulties and swallowing issues
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <img style="width: 100%; height: auto; border-radius: 8px;"
                                            src="{{ asset('/frontend/assets/uploads/service/diet_management2.png') }}" />
                                    </div>
                                </div>
