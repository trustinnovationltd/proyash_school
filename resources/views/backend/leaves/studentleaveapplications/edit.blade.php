...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form id="inputForm" method="POST" action="{{ route('student-leave-applications.update', $studentLeaveApplication->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                    @php
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="{{ $field[0] }}" class="form-select" id="{{ $field[0] }}" required>
                                ...
                                <option value="{{ $item->id }}" {{ old($field[0], $studentLeaveApplication->{$field[0]}) == $item->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="emergency_contact_number" class="form-control" id="emergency_contact_number" value="{{ old('emergency_contact_number', $studentLeaveApplication->emergency_contact_number) }}" required>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="leave_type" class="form-control" id="leave_type" value="{{ old('leave_type', $studentLeaveApplication->leave_type) }}" required>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" name="leave_application_date" class="form-control" id="leave_application_date" value="{{ old('leave_application_date', $studentLeaveApplication->leave_application_date) }}" required>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" name="leave_from" class="form-control" id="leave_from" value="{{ old('leave_from', $studentLeaveApplication->leave_from) }}" required>
                            @error('leave_from') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="col-md-3 mb-3">
                            <label for="leave_to">{{ __('messages.leave_to') }} <span>*</span></label>
                            <input type="date" name="leave_to" class="form-control" id="leave_to" value="{{ old('leave_to', $studentLeaveApplication->leave_to) }}" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="approved_by" class="form-select" id="approved_by">
                                ...
                                <option value="{{ $employee->id }}" {{ old('approved_by', $studentLeaveApplication->approved_by) == $employee->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="approved_date_from" class="form-control" id="approved_date_from" value="{{ old('approved_date_from', $studentLeaveApplication->approved_date_from) }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" name="approved_date_to" class="form-control" id="approved_date_to" value="{{ old('approved_date_to', $studentLeaveApplication->approved_date_to) }}">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="leave_reason" class="form-control" id="leave_reason" rows="3" required>{{ old('leave_reason', $studentLeaveApplication->leave_reason) }}</textarea>
                            @error('leave_reason') 
                            <span class="text-danger">{{ $message }}</span> 
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="status" class="form-select" required>
                                <option value="1" {{ old('status', $studentLeaveApplication->status) == 1 ? 'selected' : '' }}>{{ __('messages.active') }}</option>
                                <option value="0" {{ old('status', $studentLeaveApplication->status) == 0 ? 'selected' : '' }}>{{ __('messages.inactive') }}</option>
                            </select>
