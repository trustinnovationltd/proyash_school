                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mb-3">
                                ...
                                <select name="status" class="form-control" required>
                                    <option value="1" {{ old('status', $assignEmployee->status ?? '') == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="2" {{ old('status', $assignEmployee->status ?? '') == '2' ? 'selected' : '' }}>Pending</option>
                                    <option value="0" {{ old('status', $assignEmployee->status ?? '') == '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
