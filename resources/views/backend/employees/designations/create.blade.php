...
@section('title', __('messages.add_designation'))
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">{{ __('messages.add_designation') }}</h3>
                </div>
                <!-- form start -->
                <form id="inputForm" method="POST" action="{{ route('designations.store') }}">
                    @csrf
                    <div class="card-body">
                        <div class="row">
