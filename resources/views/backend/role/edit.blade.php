...
@section('active_menu', 'Role Management')

@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="card role-edit-card shadow-lg">
                <div class="card-header role-card-header">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-user-shield fs-3 me-3"></i>
                        <div>
                            <h3 class="mb-0 fw-bold">Edit Role: {{ $role->name }}</h3>
                            <p class="mb-0 mt-2 opacity-75">Manage role permissions and access controls</p>
                        </div>
                    </div>
                </div>
                
                <div class="card-body p-4">
                    <form class="needs-validation" method="post" action="{{ route('role.update', $role->id) }}" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="role-info-section">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="role-permission-stats h-100 d-flex flex-column justify-content-center">
                                        <h6 class="mb-3">
                                            <i class="fas fa-info-circle me-1"></i>Permission Overview
                                        </h6>
                                        <div class="row text-center">
                                            <div class="col-6">
                                                <div class="d-flex flex-column">
                                                    <span class="fs-4 fw-bold text-primary">{{ count($permission_groups) }}</span>
                                                    <span class="text-muted small">Groups</span>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="d-flex flex-column">
                                                    <span class="fs-4 fw-bold text-success">{{ count($all_permissions) }}</span>
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 mt-4">
                            ...
                            <button class="btn btn-update btn-lg" type="submit">
