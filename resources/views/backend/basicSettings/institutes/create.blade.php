...
@section('title', __('messages.add_institute'))
    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{ __('messages.add_institute') }}</h3>
            </div>
            <!-- form start -->
            <form id="inputForm" method="POST" action="{{ route('institutes.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <!-- Institute Name -->
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="eiin_code" class="form-control" id="eiin_code"
                                    placeholder="{{ __('messages.enter_eiin_code') }}" value="{{ old('eiin_code') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" class="form-control" id="address"
                                    placeholder="{{ __('messages.enter_address') }}" value="{{ old('address') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" id="phone"
                                    placeholder="{{ __('messages.enter_phone_number') }}" value="{{ old('phone') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" name="medium_ids[]"
                                                ...
                                                {{ is_array(old('medium_ids')) && in_array($medium->id, old('medium_ids')) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" name="exam_type_ids[]"
                                                ...
                                                class="form-check-input"
                                                {{ is_array(old('exam_type_ids')) && in_array($examType->id, old('exam_type_ids')) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="checkbox" name="weekly_holidays[]"
                                                ...
                                                class="form-check-input"
                                                {{ is_array(old('weekly_holidays')) && in_array($day, old('weekly_holidays')) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" name="website" class="form-control" id="website"
                                    placeholder="{{ __('messages.enter_website') }}" value="{{ old('website') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" name="map_link" class="form-control" id="map_link"
                                    placeholder="{{ __('messages.enter_map_link') }}" value="{{ old('map_link') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <div class="file-upload">
                                    ...
                                    <div
                                        class="file-upload-content py-2 file-upload-content-{{ $imageSectionTitle }}">
