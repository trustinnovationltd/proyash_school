...
@section('title', __('messages.add_exam_type'))
    ...
    <div class="col-md-8">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{ __('messages.add_exam_type') }}</h3>
            </div>
            <!-- form start -->
            <form id="inputForm" method="POST" action="{{ route('exam-types.store') }}">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <!-- Title -->
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" class="form-control" id="code"
                                    placeholder="Enter code" autocomplete="off" value="{{ old('code') }}">
