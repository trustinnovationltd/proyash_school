...
@section('title', __('messages.add_department_mgt'))
    ...
    <div class="col-md-8">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">{{ __('messages.add_department_mgt') }}</h3>
            </div>
            <!-- form start -->
            <form id="inputForm" method="POST" action="{{ route('department-mgts.store') }}">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <!-- Title -->
