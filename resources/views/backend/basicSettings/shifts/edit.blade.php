    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form id="inputForm" method="POST" action="{{ route('shifts.update', $shift->id) }}">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="description" placeholder="Enter description">{{ old('description', $shift->description) }}</textarea>
