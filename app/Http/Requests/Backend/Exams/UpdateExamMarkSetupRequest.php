...
class UpdateExamMarkSetupRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        // $examMarksSetupId = $this->route('exam_marks_setup');
        ...
        return [
            ...
            'subject_setup_id' => 'required|exists:subject_setups,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'subject_setup_id.required' => 'Subject Setup is required.',
